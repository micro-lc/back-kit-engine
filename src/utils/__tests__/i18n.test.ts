import {getLocalizedText, getNavigatorLanguage} from '../i18n'
...
describe('i18n tests', () => {
  it.each([
    ...
    ['str', '123456789', 'str'],
    [{}.toString(), undefined, {}],
    ['str', 'en', {en: 'str', it: 'abc'}],
    ['str', undefined, {en: 'str', it: 'abc'}],
    ['abc', 'it', {en: 'str', it: 'abc'}]
  ...
  it('should return translation according to navigator.language', () => {
    ...
    Object.defineProperty(window, 'navigator', {writable: true, value: {language: 'ab'}})
  ...
  it('should return navigator language', () => {
    const {navigator} = window
    Object.defineProperty(window, 'navigator', {writable: true, value: {language: '123456789'}})
